...
$current_path = '../../../../frontend/web/images/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../../../frontend/web/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
